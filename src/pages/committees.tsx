...
const committeesData = [
    {
        ...
        description: "A council of nobles, warriors, and merchants must navigate myth, politics, and war to secure Sundiata’s rise to power.",
...
<div className="container mx-auto py-10">
  ...
  <div className="text-center mb-6">
    <p className="text-lg text-gray-700">
      Click on the buttons below to filter through specific committees by category.
    </p>
  </div>
