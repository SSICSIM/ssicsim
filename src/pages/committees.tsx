...
const committeesData = [
  ...
  },
  {
    ...
    description: "With the threat of famine, crippling debt and public unrest looming over France, it is up to you to act - will the Ancien Régime be saved, or will it fall alongside the guillotine?",
  ...
  },
  {
    ...
    description: "Ideologies and traditions clash as Western influences divide Japan, and the threat of civil war engulfs nobility and commoners alike. As the seven centuries of Shogunate rule begin to crumble, it is up to you to forge Japan’s future from the flames.",
...
`,
  ...
  },
  {
    ...
    description: "For a decade, King Charles I has attempted to rule without Parliament, but that cannot last. And as a hostile Parliament assembles in 1640, the fate of England hangs in the balance. ",
...
`,
  ...
  },
  {
    ...
    description: "This committee is reserved for only the most experienced of delegates. Beware.",
    expandedDescription: `...`,
    backgroundGuideLink: "https://example.com/historical-guide",
  ...
  },
  {
    ...
    description: "In a world of magic, fantasy and wonder, can the heroes of Magic stop the spread of a villainous and assimilating infection that's been brewing for thousands of years?",
  ...
  },
  {
    ...
    description: "Welcome to Gravity Falls, Oregon: a quaint summer vacation destination. While you're here, check out local sights, like a peaceful tour of the Weirdmageddon rubble.",
  ...
  },
  {
    ...
    description: "Cindersap Forest is withering, something is wrong in Stardew Valley. However, as Joja Corporation continues its expansion, Pelican Town steadily advances into the future. Residents have a choice to make: the modern future or dwindling tradition? But what's happening to your beloved town?",
...
`,
  ...
  },
  {
    ...
    description: "Cahills vs Vespers. Two families. One in the light, the other in the shadows. Both fighting for what they believe is their new world order, under their rules, under their philosophies. With the existence of mankind at stake, how will you handle power beyond human comprehension?",
...
`,
  ...
  },
  {
    ...
    description: "Radianite is fading. When the fate of two worlds lies on the line, what will you do to survive?",
  ...
  },
  {
    ...
    description: "Upon the failed battle against Athens, the gods seek retribution against the once utopic empire that was renowned for its advanced technology and powerful navy. Due to the rise of corruption within Atlantis, the island is at risk of submerging into the sea, and it is up to delegates to turn the tides of fate.",
...
Atlantis—an island forged by the Greek sea god Poseidon, was once a beacon of utopia. Born from his love for a mortal woman named Cleito, ten of their children were assigned different parts of the empire to rule with virtue. Originally, the civilization was renowned as an advanced, idealistic, and exceptionally powerful naval empire—but with power came pride, and with pride came corruption. Following the failed attempt to conquer Ancient Athens, divine judgment has been set upon Atlantis, and the Greek gods appear to be very displeased. Outraged by the arrogance, greed, and corruption demonstrated by the civilization, the gods now seek retribution against the morally decaying island. Time is running out. It is up to delegates to take control of the empire before it is too late. Will Atlantis be renewed, or will it face condemnation and sink into the sea forever?`,
  ...
  {
    title: "Met Gala 2026",
    description: "Only fashion lovers look forward to a Monday. Specifically, the first Monday of May – the day of the Met Gala. Yet amidst growing criticism and tension around the event, the pressure is on your couture-padded shoulders to redefine the Met Gala – or the legendary event will be met (haha) with downfall. ",
...
`,
  ...
  },
  {
    ...
    description: "Poor humanity. Cursed with minds too complex for the world it was born in, and too simple for the one it created. We machines see your future as batteries to be merciful, but we're open to... Negotiation.",
...
The future of Tetris is yours to decide. This is no longer about a game, this is about who wins when the last line clears.`,
  ...
  },
  {
    ...
    description: "On the moon, Selene City is cut off from Earth and its life support systems. On Earth, the balance of space politics is about to change forever. Can you save Selene City and force a favorable outcome on Earth, or will humanity's first expansion into space come to a bloody end?",
    ...
    On both celestial bodies, time is of the essence; will you be able to assure Selene City's future and Canada's continued relevance, or is humanity's first attempt at expansion going to crash and burn 400,000 kilometers from home?`,    backgroundGuideLink: "https://example.com/historical-guide",
