      ...
      <section className="relative py-20 bg-[#F9F8F5]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center px-6">
          ...
          >
            ...
            <p>
                We acknowledge the <strong>traditional territory</strong> where we gather, carrying the footprints of the <strong>Wendat, Haudenosaunee, and Anishinaabek nations</strong> who have sought to <strong>walk gently on this land.</strong>
                </p>
                <p>
                They offered <strong>assistance to the first European travellers</strong> and shared vital knowledge. This land is governed by a treaty with the <strong>Mississaugas of the Credit River First Nation</strong> and the <strong>Dish With One Spoon agreement</strong> between the <strong>Anishinaabek and Haudenosaunee nations.</strong>
                </p>
                <p>
                We recognize the <strong>enduring presence</strong> of all <strong>First Nations, Métis, and Inuit peoples.</strong> Moving toward reconciliation, we seek to <strong>polish the silver Covenant Chain</strong> and restore relationships between the <strong>Onkwehonwe (Original) and settler peoples</strong> with <strong>honour and respect.</strong>
                </p>
                <p>
                Land acknowledgements remain <strong>sites of resistance and socio-political contestation</strong>. This acknowledgement is a <strong>starting point</strong> calling for <strong>deeper reflection</strong> and taking up <strong>responsibility as treaty beneficiaries</strong> on these lands.
                </p>
