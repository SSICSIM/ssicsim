  ...
  return (
    <>
      ...
      <div className="relative bg-gray-100 min-w-full min-h-screen pt-7">
        ...
        <div className="grid grid-cols-1 gap-6 lg:gap-0 lg:grid-cols-2 w-[100%] mx-auto">
{/* Financial Aid Section */}
<div className="container mx-auto py-20 text-center w-[90%] bg-gradient-to-br from-[#A3841D] to-[#C2A95F] h-auto rounded-2xl p-6 z-20 shadow-lg hover:shadow-xl transition-shadow duration-300">
  ...
  <p className="text-lg text-white font-dm-sans mb-4">
    <span className="font-bold">SSICSIM offers financial aid options</span> to help cover the costs associated with the conference. You can apply for this aid during the registration process, even if your school is covering part of your expenses. Our goal is to make our experiences as accessible as possible at all times. We never want attendees to have finance or payment as a barrier to entry to our conference.
  </p>
  <p className="text-lg text-white font-dm-sans mb-4">
    <span className="font-bold">When you begin the registration process</span>, you will find an option to apply for financial aid on the registration form. Please provide a brief explanation of your financial situation and the reasons why you are seeking assistance. This information will help us understand your circumstances and provide the necessary support.
  </p>
  <p className="text-lg text-white font-dm-sans mb-4">
    <span className="font-bold">Financial aid provided by SSICSIM</span> is only applicable towards the delegate registration fee. SSICSIM does not subsidize external costs such as transportation or accommodations. Please note that full or partial financial aid is not guaranteed and will be assessed on a case-by-case basis. Consequently, delegation registration emails might take longer to send out for those who requested aid due to the processing time.
  </p>
  <p className="text-lg text-white font-dm-sans mb-4">
...
<div className="container mx-auto py-20 text-center w-[90%] bg-gradient-to-br from-[#A3841D] to-[#C2A95F] h-auto rounded-2xl p-6 z-20 shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col justify-center">
  ...
  <p className="text-2xl text-white font-dm-sans mb-4">
    ...
    <span className="font-bold">how</span> to pay the delegate registration fee, please contact our USG Internal.
  </p>
  ...
  <p className="text-2xl text-white font-dm-sans mb-8">
    Alternatively, you may view this helpful document on how to pay the delegate registration fee at any of Canada’s largest banks:
  </p>
