...
<div className="container mx-auto py-10 mt-6">
  <h2 className="text-5xl font-bold font-dm-sans text-center mb-8">Pricing*</h2>
  <p className="text-center text-gray-500 mb-6">*All prices are in Canadian Dollars (CAD$)</p>
  ...
  <div className="grid grid-cols-3 gap-4">
    ...
    <div className="bg-[#A3841D] text-white p-6 rounded-lg shadow-lg flex flex-col justify-center items-center">
      ...
      <p className="text-lg font-dm-sans mt-4">Early Bird Registration</p>
    ...
    <div className="bg-gray-100 text-gray-400 p-6 rounded-lg shadow-lg flex flex-col justify-center items-center">
      ...
      <p className="text-sm font-light mt-2">August 1st – September 21st, or until we reach capacity.</p>
    </div>

    {/* Late Bird Pricing */}
    <div className="bg-gray-100 text-gray-400 p-6 rounded-lg shadow-lg flex flex-col justify-center items-center">
      <p className="text-6xl font-bold">$100</p>
      <p className="text-lg font-dm-sans mt-4">Late Bird Registration</p>
      <p className="text-sm font-light mt-2">September 22nd – September 30th, or until we reach capacity.</p>
    </div>
  </div>
</div>
...
<div className="relative z-10 flex justify-center">
  <div className="grid grid-cols-2 grid-rows-4 w-[80%] min-h-[100%]">
    {/* First Column (Spanning All Rows) */}
    <div className="row-span-4 p-6 flex flex-col justify-center">
      <h1 className="text-7xl font-bold font-dm-sans ml-6">Registration</h1>
      <p className="text-gray-700 text-2xl font-dm-sans font-light w-[30vw] ml-6 pt-2">
        Whether you are an individual or group delegation, it’s easy to register for SSICSIM 2025!
      </p>
...
<div className="container mx-auto py-20 text-center">
  <h2 className="text-5xl font-bold font-dm-sans text-black mb-8">Payments</h2>
  <p className="text-lg text-black mb-4">
    If you have questions or concerns on <span className="font-bold">how</span> to pay the delegate registration fee, please contact our USG Internal.
  </p>
  <p className="text-lg text-black mb-8">
    Connor Begg | <a href="mailto:internal@ssicsim.ca" className="underline">internal@ssicsim.ca</a>
  </p>
  <p className="text-lg text-black mb-8">
