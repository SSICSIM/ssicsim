              ...
              {isImageLeft || isLast ? (
                ...
                >
                  {branchPhotos[branch].map((imgSrc, idx) => (
                    <div
                      key={idx}
                      className={`w-[90%] mx-auto h-full md:h-[50%] rounded-md overflow-hidden relative min-h-[220px] md:min-h-[350px]`}
                    >
                      <Image
                        src={imgSrc}
                        alt={`${branch} ${idx + 1}`}
              ...
              {!isImageLeft && !isLast ? (
                <div className="w-full lg:w-[40%] flex flex-col gap-4">
                  {branchPhotos[branch].map((imgSrc, idx) => (
                    <div
                      key={idx}
                      className="w-full h-full lg:h-auto rounded-md overflow-hidden relative min-h-[250px] md:min-h-[450px]"
                    >
                      <Image
                        src={imgSrc}
                        alt={`${branch} ${idx + 1}`}
