...
const Landing = () => {
  ...
  useEffect(() => {
    ...
    if (!selectedCommitteeData) return;
    ...
    <>
      ...
      <div>
        <div className="relative w-full min-h-[500px] h-screen max-h-[1200px] overflow-hidden pt-[80px]">
          ...
          {/* Content Section */}
          <div className="max-w-[1536px] mt-12 mx-auto absolute inset-0 h-full flex flex-col items-start justify-center font-nunito z-20 2xl:px-0 px-12">
            <h3 className="text-white text-left md:text-[35px] w-[80vw] lg:w-[800px] text-[25px] font-normal italic md:w-[800px]">
              Toronto, ON
            </h3>
            <h1 className="text-white text-left md:text-5xl lg:text-7xl font-bold leading-tight text-4xl w-3/5">
            ...
            <div className="flex flex-row gap-6">
              <a
                ...
                className="mt-4 bg-[#F3C02C] text-[#3C2C2C] px-8 py-4 rounded-lg font-dm-sans text-xl md:text-2xl font-bold hover:bg-[#F2A900] transition-colors"
              >
                Register Now!
              </a>
              <a
                href="/wrapped"
                rel="noopener noreferrer"
                className="mt-4 bg-white text-[#A3841D] px-8 py-4 rounded-lg font-dm-sans text-xl md:text-2xl font-bold hover:bg-gray-100 transition-colors"
              >
      ...
      <div
        className="relative bg-white h-[40rem] w-full flex items-center justify-center overflow-hidden bg-cover bg-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-[1024px] h-auto w-full flex flex-col items-center justify-center text-center py-12 xl:mx-0 mx-12 px-8 bg-white/60 backdrop-blur-lg rounded-2xl shadow-2xl">
      ...
      <div className="relative bg-[#A3841D] w-screen grid grid-rows-auto">
        ...
        ></div>
        {/* Text Content */}
        <div className="flex flex-col gap-12 py-12 max-w-[1536px] mx-auto 2xl:px-0 px-18">
          <div className="flex flex-col">
            <p className="text-[24px] md:text-[30px] font-extralight text-white font-grotesque">
              SSICSIM 2026
            </p>
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4 xl:gap-8">
              ...
              <div className="md:w-1/2 flex flex-col">
                ...
                <a
                  href="/about/mission"
                  rel="noopener noreferrer"
                  className="bg-white mt-3 text-[#A3841D] px-6 py-3 w-[200px] rounded-lg font-dm-sans text-xl text-center hover:bg-gray-100 transition-colors"
                >
                  Learn More
                </a>
              </div>
          ...
          {/* Cards Section */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-auto h-auto overflow-hidden z-[20]">
        ...
        <div className="bg-gray-100 h-auto w-full relative">
          ...
          ></div>{" "}
          <div className="relative z-[20] max-w-[1024px] mx-auto h-auto w-full px-12 lg:px-0 flex flex-col gap-4 md:flex-row justify-center">
            {/* Committee Types */}

            <div className="flex flex-col justify-center items-center gap-4 w-full z-[20]">
            ...
            <div className="w-full flex items-center justify-center z-40">
              <div className="relative w-full md:w-full h-[320px] md:h-full">
                {committees.map((committee) => (
                  <NextImage
                    key={committee.image}
                    src={committee.image}
                    ...
                    className={`committee-image object-cover rounded-lg transition-opacity duration-300 z-10 ${
                      selectedCommittee === committee.title
                        ? "opacity-100"
                        : "opacity-0"
                    }`}
                    priority={false}
                ...
                <NextImage
                  key="Default"
                  src={`${CF_DOMAIN}/Default.JPG?format=webp`}
                  alt="Default"
                  fill
                  sizes="(max-width: 768px) 80vw, 40vw"
                  className={`committee-image object-cover rounded-lg transition-opacity duration-300 z-10 ${
                    selectedCommittee === null ? "opacity-100" : "opacity-0"
                  }`}
                  priority={false}
                />
              </div>
