...
const DirectorHiring = () => {
  ...
  const oaQuestions = [
    ...
    },
    {
      ...
      answer: (
        <p>
          We are looking for 3 Operations Assistants to assist with outreaching
          to sponsors.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          Yes, but we will disregard your OA/MSD application if you accept a
          Director role.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          Outreach/external experience & MUN experience aren't required, but
          they are both good to have! We are mainly looking for someone who is
          passionate about Model UN and diplomacy, and has strong communication
          skills and ability to learn quickly. However, we do weigh
          Outreach/external experience higher, but MUN experience is still good
          to have to know the logistics of the conference.
        </p>
      ),
    },
  ];
  ...
  const msdQuestions = [
    {
      question:
        "What are the requirements to apply to be a Mechanics Software Developer for SSICSIM 2026?",
      answer: (
        <ul className="list-disc pl-6 space-y-2">
          <li>
          ...
          <li>
            Proficiency in common industry programming language(s), such Python,
            HTML, and/or JavaScript.
          </li>
          <li>
            A strong ability to learn and adapt to new programming languages and
            software development tools quickly and independently.
          </li>
          <li>
            <strong> Preferred (Not Required): </strong> At least 1 year of
            experience in Operations at SSICSIM/UTMUN/NAMUN.
          </li>
          <li>
            <strong> Preferred (Not Required): </strong> Major(s) in
            engineering, computer science, information technologies (IT), or
            other equivalent technical program(s).
          </li>
          <li>
            <strong> Preferred (Not Required): </strong> Experience in
            programming design and/or creating software for diverse applications
            demonstrated through classwork, personal projects, or other
            examples.
          </li>
        </ul>
      ),
    },
    {
      ...
      answer: (
        <p>
          We currently use a React-based for our website hoping to migrate to
          next.js soon, and looking into using FastAPI (Python) for our backend
          for internal tools. However, we are open to using other frameworks and
          programming languages if there are better options that you may
          suggest.
        </p>
      ),
    },
    {
      question:
        "I don't have experience in all of the frameworks/languages mentioned above. Should I still apply?",
      answer: (
        <p>
          <strong>Yes!</strong> In fact we highly encourage you to apply even if
          you don't have experience in all of the languages mentioned above. We
          are mainly looking for someone who has strong critical thinking
          skills, problem solving skills and ability to learn quickly, and we
          are happy to help you to learn any necessary frameworks/languages if
          you are selected for this role.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          We've noticed that internal processes and committee management before
          and during the conference often lack simplicity and automation. This
          year, we want to use this opportunity to experiment and improve the
          experience for both delegates and staff. This is a new role this year,
          and we're excited to see how it develops! <br></br>
          <br></br> One main area where we've identified complexity is in
          committee mechanics, where tracking certain elements during the
          conference can be challenging, and that's where we come in!
        </p>
      ),
    },
  ];
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-[15px] lg:text-[20px] font-light text-[#A3841D] font-dm-sans">
                    In the event that we select you for an interview, you will
                    be contacted by email. Please keep an eye on your spam box
                ...
                <div className="relative group">
                  ...
                  <div className="relative w-full h-full min-h-[280px]">
                    <Image
                      ...
                      className="rounded-lg shadow-2xl object-cover transform group-hover:scale-[1.02] transition duration-300"
                      priority={false}
                    />
                    {/* Overlay gradient */}
          ...
          <div className="flex flex-col-reverse md:grid md:grid-cols-2 w-full gap-8 px-6">
            ...
            <div className="p-4">
              ...
              <p className="text-[15px] md:text-[20px] mt-4 lg:text-[25px] font-light text-[#A3841D] font-dm-sans">
                Operation Assistant is a reccuring role at SSICSIM. OA
                responsibilities include researching and coordinating with
                potential sponsors, organising and preparing conference
                materials, and maintaining a detailed database of contact
                information. <br></br>
                <br></br>
                You'll be working with the Secretariat in the weeks leading up
                to the conference to help organize and prepare conference
                materials.
              </p>
              <div className="flex md:flex-row flex-col gap-3 md:gap-6 w-full mt-6">
                <a
        ...
        <div className="relative z-10 flex max-w-[3000px] mx-auto">
          <div className="grid w-full grid-cols-1 md:grid-cols-2 gap-8 px-6">
            <div className="p-4">
              ...
              <p className="text-[15px] md:text-[20px] mt-4 lg:text-[25px] font-light text-[#A3841D] font-dm-sans">
                The Mechanics Software Developer role is a{" "}
                <strong>new role</strong> at SSICSIM this year! MSD
                responsibilities include maintaining the SSICSIM website
                alongside the Webmaster, developing software to support SSICSIM
                committees mechanics, and day-of conference support. <br></br>
                <br></br>
                You'll also have the opportunity to work with the Webmaster in
                the maintenance and development of the SSICSIM website alongside
                automation initiatives for processes, including registration,
                committee assignments, and communications needs.
              </p>
              <div className="flex md:flex-row flex-col gap-3 md:gap-6 w-full mt-6">
                <a
