...
Atlantis—an island forged by the Greek sea god Poseidon, was once a beacon of utopia. Born from his love for a mortal woman named Cleito, ten of their children were assigned different parts of the empire to rule with virtue. Originally, the civilization was renowned as an advanced, idealistic, and exceptionally powerful naval empire—but with power came pride, and with pride came corruption. Following the failed attempt to conquer Primeval Athens, divine judgment has been set upon Atlantis, and the Greek gods appear to be very displeased. Outraged by the arrogance, greed, and corruption demonstrated by the civilization, the gods now seek retribution against the morally decaying island. Time is running out. It is up to delegates to take control of the empire before it is too late. Will Atlantis be renewed, or will it face condemnation and sink into the sea forever?`,
    backgroundGuides: [
      {
        description: "Background Guide",
