...
export const committeesData = [
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1e-w5s0gEAe4kITF9_JCSXLahQn43Pgpc/view?usp=drive_link",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1R7-sIEkImOr1qHR8W6_gieuK66MENRAR/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    director: "Paula Chu",
    directorImage: "",
    logo: "/assets/photos/committee-logos/LandOfThePharaohs.png",
    category: "Historical",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1vTQWHN3lj6sPEi_dkBFPBUhBSov-7ZHq/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/FrancoPrussianWar.png",
    category: "Historical",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1cczb_6tT2ePzvFrzDhfcT5cnV8qjI1di/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/Rovereta.png",
    category: "Historical",
  ...
  },
  {
    ...
    expandedDescription: "???",
    backgroundGuides: [],
    contactEmail: "histadhoc@ssicsim.ca",
    director: "Alexander Boldis",
    directorImage: "",
    logo: "/assets/photos/committee-logos/HistoricalAdHoc.png",
    category: "Historical",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1-2OocFkmtVFsru4Flfp0Zy80RnwSSAql/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/LordOfTheRings.png",
    category: "Fictional",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/110dLh5q5y9Gu_hath4kjJUoiG4W-YnNl/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/DeathNote.png",
    category: "Fictional",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1vj1VcQqDxqE833hAxKEEienM417V0e7F/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/Pokemon.png",
    category: "Fictional",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/14pIHj8rvIWopO5ClbY4-coT7SOKwid5_/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    contactEmail: "wizardingpuzzle@ssicsim.ca",
    director: "Renzo Ugarte Basurco & Maria Aponiuk Sawicz",
    directorImage: "",
    logo: "/assets/photos/committee-logos/Wizarding.png",
    category: "Fictional",
  ...
  },
  {
    ...
    expandedDescription: "???",
    backgroundGuides: [],
    contactEmail: "ficadhoc@ssicsim.ca",
    director: "Jordan Bickramsingh",
    directorImage: "",
    logo: "/assets/photos/committee-logos/FictionalAdHoc.png",
    category: "Fictional",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1cbdN3LrQkpaiBzchK1bYB8Bfxw3g6TgC/view?usp=drivesdk",
        description: "Background Guide",
      },
    ],
    ...
    director: "Evelyn So",
    directorImage: "",
    logo: "/assets/photos/committee-logos/MarshallCarterDark.png",
    category: "Conceptual",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1N2wq_lZQFgq1-_d-7TcoM9mX2wpQ93cY/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/RisingIdols.png",
    category: "Conceptual",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1QYCLMurHH_L0GqkjtBPQG1-ChA8si2U9/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    director: "Lily Cohen",
    directorImage: "",
    logo: "/assets/photos/committee-logos/Titanomachy.png",
    category: "Conceptual",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1h-nb6qS1_XPKKOMgXM7QP8Aphb-20oCk/view?usp=drive_link",
        description: "Background Guide",
      },
    ],
    ...
    directorImage: "",
    logo: "/assets/photos/committee-logos/DigitalGoldRush.png",
    category: "Conceptual",
  ...
  },
  {
    ...
    backgroundGuides: [
      {
        link: "https://drive.google.com/file/d/1H1QWvl7yTBKVbdGFkcEMvYA-kUw6ulWf/view?usp=drive_link",
  ...
  },
  {
    ...
    backgroundGuides: [],
    contactEmail: "conadhoc@ssicsim.ca",
    director: "???",
    directorImage: "",
    logo: "/assets/photos/committee-logos/ConceptualAdHoc.png",
    category: "Conceptual",
