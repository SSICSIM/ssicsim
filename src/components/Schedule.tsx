...
const events: MyEvent[] = [
  ...
  {
    id: 2,
    title: "Legislative Assembly Tours",
    start: new Date(2025, 9, 24, 9, 30),
    end: new Date(2025, 9, 24, 11, 0),
    category: "charity",
  },
  {
    id: 3,
    title: "Delegate Training Session 1",
  ...
  {
    id: 5,
    title: "Delegate Training Session 2",
  ...
  },
  {
    ...
    start: new Date(2025, 9, 24, 17, 30),
    end: new Date(2025, 9, 24, 19, 0),
    category: "committee",
  },
  {
    id: 8,
    title: "Midnight Crisis",
    start: new Date(2025, 9, 24, 20, 0),
    end: new Date(2025, 9, 24, 23, 0),
    category: "other",
  },
  // Saturday
  {
  ...
  {
    id: 10,
    title: "Lunch + Charity Photoshoot",
    start: new Date(2025, 9, 25, 12, 0),
    end: new Date(2025, 9, 25, 13, 30),
    category: "charity",
  },
  {
    id: 11,
  ...
  },
  {
    id: 12,
    title: "Break",
    start: new Date(2025, 9, 25, 15, 30),
  ...
  {
    id: 14,
    title: "Delegate/FA Feedback",
    start: new Date(2025, 9, 25, 18, 0),
    end: new Date(2025, 9, 25, 18, 30),
    category: "other",
  },
  {
    id: 15,
  ...
  },
  {
    ...
    end: new Date(2025, 9, 26, 13, 30),
    category: "charity",
  },
  {
    id: 18,
    title: "Committee Session 6",
    start: new Date(2025, 9, 26, 13, 30),
    end: new Date(2025, 9, 26, 15, 30),
    category: "committee",
  },
  {
    id: 19,
    title: "Delegate/FA Feedback",
    start: new Date(2025, 9, 26, 15, 30),
  ...
  },
  {
    ...
    end: new Date(2025, 9, 26, 16, 30),
    category: "other",
  },
  {
    id: 21,
    title: "Closing Ceremonies",
    start: new Date(2025, 9, 26, 16, 30),
    end: new Date(2025, 9, 26, 18, 0),
    category: "ceremony",
  },
];
