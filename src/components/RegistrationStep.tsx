interface RegistrationStepProps {
  ...
  const RegistrationStep = ({ title, description }: RegistrationStepProps) => {
    return (
      <div className="w-full h-full rounded-lg p-8 flex flex-col items-center md:flex-row bg-gradient-to-r from-[#F3F4F6] to-[#E5E7EB] shadow-lg text-black transition-colors duration-300 hover:bg-[#A3841D] hover:text-white">
